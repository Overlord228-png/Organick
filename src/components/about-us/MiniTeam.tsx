...
const team = [
    {
        id: 1,
        img: "../../../public/assets/img/Giovani Bacardo-min.jpg",
        name: "Giovani Bacardo",
        role: "Farmer",
    },
    {
        id: 2,
        img: "../../../public/assets/img/Marianne Loreno-min.jpg",
        name: "Marianne Loreno",
        role: "Designer",
    },
    {
        id: 3,
        img: "../../../public/assets/img/Riga Pelore-min.jpg",
        name: "Riga Pelore",
        role: "Farmer",
    },
];
                ...
                <ul className="team-us__content-items">
                    ...
                    <li className="team-us__content-items-item" key={persone.id}>
                        ...
                        <div className="team-us__wrapper">
                            <h3 className="team-us__content-items-item-info-name">{persone.name}</h3>
